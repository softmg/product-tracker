---
name: refactor
description: Refactor workflow - Analyze → Refactor → Verify → Docs. Uses senior-reviewer to find targets, refactor agent to apply changes, test-runner to verify no behavior change.
---
...
**Do NOT analyze code. Do NOT refactor files. Do NOT run tests directly.**
