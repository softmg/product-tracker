---
name: docs
description: Project documentation structure and configured paths. Use when creating or updating docs, locating where plans/reports/issues/architecture docs live, or understanding the documentation layout configured in .cursor/config.json. Do NOT use for code implementation or code review.
...
Read documentation files directly using the configured paths from `config.json`.
