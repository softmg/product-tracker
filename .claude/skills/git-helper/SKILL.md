---
name: git-helper
description: Git operations helper: Conventional Commits message generation from staged changes, branch naming and creation, merge vs rebase guidance, stash, cherry-pick, bisect, tags, and conflict resolution. Use when generating commit messages, committing changes, creating branches, resolving conflicts, undoing commits, or investigating history. Do NOT use for code implementation.
---
