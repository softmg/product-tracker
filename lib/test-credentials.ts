...
export const TEST_USERS: Record<"admin" | "initiator" | "pdManager", TestUserCredentials> = {
  admin: {
    ...
    password: resolveSecret("TEST_ADMIN_PASSWORD", "admin", "E2E_DEFAULT_PASSWORD", "password"),
  },
  initiator: {
    email: readOptionalEnv("TEST_INITIATOR_EMAIL") ?? "viewer@company.com",
    password: resolveSecret("TEST_INITIATOR_PASSWORD", "initiator", "E2E_DEFAULT_PASSWORD", "password"),
  },
  pdManager: {
    email: readOptionalEnv("TEST_PD_MANAGER_EMAIL") ?? "po@company.com",
    password: resolveSecret("TEST_PD_MANAGER_PASSWORD", "pd-manager", "E2E_DEFAULT_PASSWORD", "password"),
  },
}

export const INVALID_AUTH_CREDENTIALS: TestUserCredentials = {
  email: readOptionalEnv("TEST_INVALID_EMAIL") ?? "wrong@example.com",
  password: resolveSecret("TEST_INVALID_PASSWORD", "invalid", "E2E_INVALID_PASSWORD", "wrongpassword"),
}

export const TEST_NEW_USER_PASSWORD = resolveSecret("TEST_NEW_USER_PASSWORD", "new-user", "E2E_DEFAULT_PASSWORD", "password")
