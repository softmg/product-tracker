...
Веб-сервис для организаций, которые хотят управлять продуктовыми гипотезами по единой воронке discovery: от идеи до решения Go/No-Go/Iterate продуктового комитета.
